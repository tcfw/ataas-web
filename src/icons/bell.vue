<template>
	<svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="bell" role="img"
		xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-bell fa-w-14"
		...
		<g class="fa-group">
			...
			<path fill="currentColor" d="M160 448h128a64 64 0 0 1-128 0z" class="fa-primary"></path>
		</g>
	</svg>
</template>